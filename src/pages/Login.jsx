  ...
  return (
    <section className="pt-28 pb-12 md:pt-32 md:pb-16 bg-gray-100">
      <div className="container mx-auto px-4 max-w-5xl">
        <div className="text-sm text-gray-500 mb-2">Inicio / Iniciar sesion</div>
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_420px] gap-8 items-start">
          <div className="bg-white rounded-lg border border-gray-200 p-8">
            ...
            <p className="text-sm text-gray-500 mb-6">
              Accede para ver tu carrito y tus pedidos recientes.
            </p>
          ...
          <aside className="bg-black text-white rounded-lg p-8 space-y-4">
            <h3 className="text-2xl font-semibold">No tienes cuenta?</h3>
            <p className="text-sm text-gray-300">
              Registrate para recibir promociones y beneficios exclusivos.
            </p>
            <Link
              to="/registro"
